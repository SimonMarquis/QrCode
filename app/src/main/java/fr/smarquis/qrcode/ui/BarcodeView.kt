...
class BarcodeView @JvmOverloads constructor(
    ...
    private fun render(value: Barcode?) = with(binding) {
        when {
            ...
            value == null -> {
                ...
                if (bottomSheetBehavior().state == BottomSheetBehavior.STATE_EXPANDED) TransitionManager.beginDelayedTransition(this@BarcodeView)
